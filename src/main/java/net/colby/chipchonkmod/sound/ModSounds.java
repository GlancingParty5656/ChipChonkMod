package net.colby.chipchonkmod.sound;
...
public class ModSounds {
    ...
    public static final SoundEvent THICK_OF_IT = registerSoundEvent("thick_of_it");
    ...
    public static void registerSounds() {
        ChipChonkMod.LOGGER.info("Registering Mod Sounds for " + ChipChonkMod.MOD_ID);
    }
